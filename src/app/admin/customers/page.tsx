    ...
    const fetchCars = async () => {
      try {
        ...
        const data: Car[] = [
          ...
          { _id: "2", name: "Rolls-Royse", model: "2023", price: "$59,000", stock: 6, category: "sedan" },
    ...
    <div className="min-h-screen bg-gray-900 p-4 md:p-6 ml-0 md:ml-64">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-500">Manage and view all car information</p>
        </div>
          ...
          <div className="bg backdrop-blur-sm rounded-2xl shadow-xl overflow-hidden border border-gray-900">
            <div className="overflow-x-auto">
              <table className="w-full text-gray-400">
                ...
                <tbody className=" divide-blue-500">
