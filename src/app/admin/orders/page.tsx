...
//         <ThemedIcon
//           icon={FaSpinner}
//           className="animate-spin text-blue-500 mb-3 w-6 h-6 md:w-8 md:h-8"
//         />
...
const Orders = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-900 p-4 md:p-6 ml-0 md:ml-64">
      {/* Header Section */}
      <div className="mb-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-4 mb-6 md:mb-8">
        ...
        <div className="relative">
          <input
            type="text"
            className="w-full pl-10 md:pl-12 pr-4 py-2 md:py-3 bg-white border border-gray-200 rounded-lg md:rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-gray-500 text-sm md:text-base"
            placeholder="Search orders..."
            value={searchTerm}
            onChange={(e) => setSearchTerm(e.target.value)}
          />
        ...
        <div className="relative">
          <select
            className="w-full pl-10 md:pl-12 pr-4 py-2 md:py-3 bg-white border border-gray-200 rounded-lg md:rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-gray-500 appearance-none text-sm md:text-base"
            value={statusFilter}
            onChange={(e) => setStatusFilter(e.target.value)}
          >
        ...
        <div>
          <select
            className="w-full px-4 py-2 md:py-3 bg-white border border-gray-200 rounded-lg md:rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-black-100 text-sm md:text-base"
            value={sortBy}
            onChange={(e) => setSortBy(e.target.value)}
          >
            <option value="orderDate">Sort by Date</option>
